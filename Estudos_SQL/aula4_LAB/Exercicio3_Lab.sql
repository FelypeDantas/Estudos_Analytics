...
-- Verificar o nome da constraint de chave primária
SELECT name 
FROM sys.key_constraints 
WHERE parent_object_id = OBJECT_ID('peca');

-- Remover a chave primária da tabela peca
ALTER TABLE peca DROP CONSTRAINT PK__peca__PK__peca__2525CAE5B2EE4F1A;
